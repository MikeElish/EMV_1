  ...
  return (
    <div>
      ...
      <p className="mt-2 max-w-xl text-sm text-foreground/60">
        ...
        можно в списке категорий) — регистр не важен. «Бренд» должен
        совпадать с одним из брендов, известных системе (регистр не важен);
        неизвестный бренд остановит загрузку этой строки с ошибкой. Если
        запчасть подходит нескольким моделям техники, перечислите их в
        «Модель машины» через символ «|», например: <code>CAT 320|CAT 325</code>.
      </p>
      <p className="mt-2 max-w-xl text-sm text-foreground/60">
