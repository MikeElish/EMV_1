    ...
    <div>
      ...
      <p className="mt-2 max-w-xl text-sm text-foreground/60">
        ...
        <strong>
          ...
          Цена товара, Категория товара, Группа товаров, Тип машины, Модель
      ...
      <p className="mt-2 max-w-xl text-sm text-foreground/60">
        ...
        Ссылка на страницу товара формируется автоматически из артикула.
        «Категория товара» должна совпадать со slug уже существующей
        категории (посмотреть можно в списке категорий). Если запчасть
